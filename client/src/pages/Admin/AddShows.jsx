...
const AddShows = () => {
  ...
  const [nowPlyaingMovies, setNowPlyaingMovies] = useState([]);
  ...
  const fetchNowPlayingMovies = async ()=> {
    setNowPlyaingMovies(dummyShowsData)
  }
...
const handleRemoveTime = (date, time) => {
  ...
  return nowPlyaingMovies.length > 0 ? (
    <>
      <Title text1="Add" text2="Shows" />
      <p className="mt-10 text-lg font-medium">Now Playing Movies</p>
<div className="overflow-x-auto pb-4">
  <div className="group flex flex-wrap gap-4 mt-4 w-max">
    {nowPlyaingMovies.map((movie) => (
...
<div className="mt-8">
  ...
  <div className="inline-flex flex-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
